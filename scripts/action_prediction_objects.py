...
def predict_action(args):
    ...
    # model.head_action = ActionMultiLayerProj(2, 2 * n_out, 1024, n_features, bias=True)
    # model.action = torch.nn.Sequential(MultiLayerProj(1, 8, 1024, n_features, bias=True),torch.nn.BatchNorm1d(n_features, affine=False))
    ...
    # model.action = MultiLayerProj(1, 2, 1024, n_features, bias=False)
